...
import MeetCreate from './Meeting/MeetCreate'
import MeetDetail from './Meeting/MeetDetail'
import Calendars from './Meeting/Calendars'
...
const MyTabs = () => {
  ...
  return (
    <Tab.Navigator initialRouteName="Home" tabBarOptions={{activeTintColor: '#54D2AC', }}>
      ...
      />
      <Tab.Screen name="Friend" component={FriendTab} options={{
          tabBarLabel: 'Friend',
          tabBarIcon: ({ color }) => (
            <Icon name='people-outline' size={22} color={color} />
          ),
        }}
      />
      <Tab.Screen 
